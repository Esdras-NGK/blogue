...
//   $mode_edition = 1;
  ...
  // $edit_titre = $_POST['Titrearticle'];
  // $edit_contenu = $_POST['nomarticle'];

  if($edit_article->rowCount() ==1)
//   if(isset($_POST[$edit_article]) and !empty($_POST[$edit_article]))
  {
    $edit_article = $edit_article->fetch();
    // $edit_titre = $edit_article['titre'];
    // $edit_contenu = $edit_article['contenu'];
        ...
        <div class="row">
            ...
            <section class="col-8 p-4" id="section" style="display: flex;flex-direction: row;flex-wrap: wrap;">
                ...
                <div class="formul" style="margin:auto;  width: 100% ">
                  <form action='php/modif.php' method="post" style="padding: 0% 12%;">

                    
                      
                      <div class="bas">
                        <label for="Titrearticle">titre d'article</label><input type="text" id="Titrearticle" name="Titrearticle" placeholder="Titre article"  value="<?=$edit_article['titre'] ?>" />


                        <label for="nomarticle">description</label><textarea name="nomarticle" id="nomarticle" cols="30" rows="10" placeholder="description"><?=$edit_article['contenu'] ?></textarea>
