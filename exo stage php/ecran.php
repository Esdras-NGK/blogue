...
if(isset($_POST['Titrearticle'], $_POST['nomarticle'])){
  if(!empty($_POST['Titrearticle']) AND !empty($_POST['nomarticle'])){
    ...
    if($mode_edition == 0){
      ...
      $ins = $connection->prepare('INSERT INTO tele (titre,contenu) VALUE (?,?, ');
      ...
      // $req= $connection->query("INSERT INTO jeu(titre,contenu) VALUE("/$Titrearticle/","/$nomarticle/")");
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-8 p-4" id="section">
    ...
    <div class="formul" style="margin:auto;  width: 100% ">
                  <form action='php/result2.php' method="post" style="padding: 0% 12%;"  enctype="multipart/form-data">
                    <!-- <div class="haut">
                    ...
                    <div class="bas">
                      <label for="Titrearticle">titre d'article</label><input type="text" id="Titrearticle" name="Titrearticle" placeholder="Titrearticle"  <?php if($mode_edition ==1) {?> value="<?=$edit_article['titre'] ?>"<?php } ?> />
                      ...
                      <label for="nomarticle">description</label><textarea name="nomarticle" id="nomarticle" cols="30" rows="10"><?php if($mode_edition ==1) {?> <?=$edit_article['contenu'] ?><?php } ?></textarea>
                      
                      <!-- p if($mode_edition ==0) {?  -->
                        <!-- ?=$edit_article['contenu'] ?> -->
                        <!-- <label for="image">image</label><input type="file" id="image" name="miniature" placeholder="image"> -->
